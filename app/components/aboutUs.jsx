      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/3 flex justify-center">
            <div className="relative w-64 h-96 rounded-3xl overflow-hidden shadow-xl border-4 border-white border-opacity-20">
              <Image
                src={us}
          ...
          <div className="md:w-2/3 space-y-6">
            ...
            <p className="text-gray-300 text-lg">
              If you want to follow our journey you can follow us on X or Instagram.
            </p>
            <div className="flex space-x-4 mt-6">
              <Link href="https://instagram.com/your_instagram" target="_blank" rel="noopener noreferrer" className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded transition duration-300">
                Follow on Instagram
              </Link>
            </div>
          </div>
